		...
		<div id="middleantar">
			<div id="antar">
				<form id='formAntar' action="<?php echo base_url() ?>login" method="post" accept-charset="utf-8">
					...
					<fieldset>
						<legend><?php //echo $sql;?>Tabel Pilihan Waktu Keberangkatan</legend>
						<div class="simple">
						...
						<div class='tabel' style='width:150px;'>
							<hr><p class='awal'><?php echo $pilih ?><br>jam</p><hr>
							<?php foreach($jam as $pl): ?>
								<div>
								<?php echo $pl->jam; ?>
								</div>
							<?php endforeach; ?>
