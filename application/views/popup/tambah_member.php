...
<body>
<h3>Penambahan Member</h3>
<hr />
<?php
$attributes = array('class' => 'findNew', 'id' => 'findUser', 'name' => 'findUser' );
 echo form_open('popup/member/tambah2', $attributes); ?>
<table width="450" cellpadding="2" cellspacing="2" align="center" class="content">
	...
	<tr>
		<td width="86">Alamat</td>
		<td width="278" class="tdspecial2">
		<?php echo form_input("alamat"); ?>
		</td>
	</tr>
	<tr>
		<td width="86">No Identitas</td>
		<td width="278" class="tdspecial2">
		<?php echo form_input("no_id"); ?>
		</td>
	</tr>
	<tr>
		<td width="86">No Telp</td>
		<td width="278" class="tdspecial2">
