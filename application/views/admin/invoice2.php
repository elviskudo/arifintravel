...
?>
									...
									<input type='text' name="tanggal_sekian0" value="<?php echo date("d/m/Y") ?>" style='float:left;width:80px;margin-right:5px;' onfocus='if(this.value=="__/__/____")this.value=""' onblur='if(this.value=="")this.value="__/__/____";'>
									<label for="tanggal_sekian1" style='float:left;margin-top:5px;margin-right:5px;'>s/d</label>
									<input type='text' name="tanggal_sekian1" value="<?php echo date('d/m/Y') ?>" style='float:left;width:80px;margin-right:5px;' onfocus='if(this.value=="__/__/____")this.value=""' onblur='if(this.value=="")this.value="__/__/____";'>
